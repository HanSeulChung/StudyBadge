...
**by Hanseul**
#### 🗺️ 장소 저장
- 일정이 오프라인 일정인 경우 나중에 일정 조회할 때 장소를 지도에 보여줘야 하므로 장소를 저장합니다.
- 일정 생성할 때 장소의 id 값을 일정 생성 form data에 넣어야 하기 때문에, 장소를 먼저 저장하는 로직 필요합니다.
...
#### 🗺️ 장소 조회
- 특정 일정을 조회할 때 오프라인 일정인 경우 모임 장소를 지도에 보여줘야한다. 이때 서버에 요청하여 장소 정보를 조회합니다.
